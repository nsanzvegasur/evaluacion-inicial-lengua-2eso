...
Cuando el tren llegó a la estación final, la luz del amanecer comenzó a aparecer entre los edificios. El viajero bajó lentamente, respiró hondo y caminó sin prisa hacia la salida.""",
            ...
            "preguntas": [
                ...
                {
                    "id": "c1_personajes",
                    "enunciado": "1.1. Indica los PERSONAJES del texto."
                },
                {
                    "id": "c1_tiempo",
                ...
                {
                    "id": "c2_accion1",
                    "enunciado": "1.2. Escribe la PRIMERA acción que ocurre en el texto en infinitivo."
                },
                {
                    "id": "c2_accion2",
                    "enunciado": "1.2. Escribe la SEGUNDA acción que ocurre en el texto en infinitivo."
                },
                {
                    "id": "c2_accion3",
                    "enunciado": "1.2. Escribe la TERCERA acción que ocurre en el texto en infinitivo."
                },
                {
                    "id": "c3_resumen",
        ...
        "textos": {
            ...
            "fragmentos": [
                {
                    "id": "tA",
                    "nombre": "Texto A",
                    "texto": "Apaga el horno y deja reposar la masa durante diez minutos antes de usarla."
                },
                {
                    "id": "tB",
                    "nombre": "Texto B",
                    "texto": "Los mamíferos son animales vertebrados que alimentan a sus crías con leche."
                },
                {
                    "id": "tC",
                    "nombre": "Texto C",
                    "texto": "Reciclar ayuda a reducir la contaminación y cuidar el medio ambiente."
                }
            ],
            ...
            "preguntas": [
                {
                    "id": "t1",
                    "enunciado": "4.1. Texto A → indica el TIPO DE TEXTO."
                },
                {
                    "id": "t2",
                    "enunciado": "4.1. Texto B → indica el TIPO DE TEXTO."
                },
                {
                    "id": "t3",
                    "enunciado": "4.1. Texto C → indica el TIPO DE TEXTO."
                },
                {
                    "id": "t4",
